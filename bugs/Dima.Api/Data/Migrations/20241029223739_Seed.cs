...
namespace Dima.Api.Migrations
{
    ...
    public partial class Seed : Migration
    {
        ...
        {
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Alimentação', 'Despesas com alimentos e bebidas', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Saúde', 'Gastos com saúde e bem-estar', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Transporte', 'Custos com transporte e veículos', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Moradia', 'Despesas relacionadas à casa', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Educação', 'Gastos com educação e cursos', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Lazer', 'Despesas com atividades de lazer', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Roupas', 'Gastos com vestuário', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Investimentos', 'Investimentos e aplicações financeiras', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Impostos', 'Pagamentos de impostos e taxas', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Viagem', 'Despesas com viagens e turismo', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Presentes', 'Gastos com presentes e doações', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Beleza', 'Despesas com beleza e cuidados pessoais', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Pets', 'Gastos com animais de estimação', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Telefonia', 'Custos com telefonia e internet', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Seguros', 'Pagamentos de seguros diversos', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Saúde Mental', 'Despesas com psicologia e terapias', 'teste@balta.io');");
            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Category] (Title, Description, UserId) VALUES('Fitness', 'Gastos com academia e atividades físicas', 'teste@balta.io');");

            migrationBuilder.Sql(@" INSERT  INTO [dbo].[Transaction] (Title, CreatedAt, PaidOrReceivedAt, Type, Amount, CategoryId, UserId)
...
VALUES('Bonificação', '2024-05-24', '2024-05-24', 1, 1200.00, (SELECT Id FROM[dbo].[Category] WHERE Title = 'Investimentos'), 'teste@balta.io');");
            ...
            migrationBuilder.Sql(@" INSERT  INTO [Product] VALUES('Plano Anual', '1 ano de acesso a plataforma', 'plano-anual', 1, 799.90)");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"TRUNCATE TABLE [dbo].[Category];");
            migrationBuilder.Sql(@"TRUNCATE TABLE [dbo].[Transaction];");
            migrationBuilder.Sql(@"TRUNCATE TABLE [dbo].[Transaction];");
        }
    }
}
